...
/*   @Override public Lugar elementoPos(int pos) {
      Log.e("Mis Lugares", "ERROR: el método elementoPos() no se implementa en la clase LugaresBD. Si necesitas este método utiliza LugaresBDAdapter");
      return null;
   }*/
